...
for (let i = 0; i < 10; i++) {
        document.write(`<div>${locations[i].title}</div>`);
}
...
for (let i = 0; i < 10; i++) {
        document.write(`<div>${locations[i].title} ${i}</div>`);
}
...
// while (i < 20) {
//     document.write(`<h1>${locations[i].title}</h1>`);
//     i++;
// }
...
while (i < 20) {
    document.write(`<h1>${locations[i].title} ${i}</h1>`);
    i++;
}
...
for (const product of products) {
    document.write(`
        <div class="product-card">
            ...
            <img src="${product.image}" alt="${product.title}" class="product-title">
        </div>
`)
